...
interface UserProductivityPieChartProps {
  data: ChartDataItem[];
}
...
const UserProductivityPieChart: React.FC<UserProductivityPieChartProps> = React.memo(({ data }) => {
  ...
  if (!data || data.length === 0) {
    return <p className="text-gray-500 dark:text-slate-400 text-center py-10">No productivity data available for this period.</p>;
  }
  return (
    <div className="min-h-[250px] h-72 sm:h-80 w-full">
...
export default UserProductivityPieChart;
