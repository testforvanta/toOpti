...
import { MeetingDetailsData } from '../types';
  ...
  return (
    ...
    >
      <div
        ...
        className="bg-white dark:bg-zinc-900 rounded-xl md:rounded-2xl shadow-soft-dreamy dark:shadow-dark-soft-dreamy w-full max-w-xl md:max-w-2xl max-h-[90vh] overflow-y-auto p-6 md:p-8 transform animate-modal-content-appear"
